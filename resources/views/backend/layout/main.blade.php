...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center"
                ...
                <div class="sidebar-brand-text mx-3">Terinfo System</div>
            </a>
            ...
            <li class="nav-item active">
                <a class="nav-link" href="{{ route(auth()->user()->role . '.dashboard.index') }}">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item"
                                    href="{{ route(auth()->user()->role . '.dashboard.profile') }}">
                                    <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Profile
                                </a>
                                <a class="dropdown-item"
                                    href="{{ route(auth()->user()->role . '.dashboard.resetPassword') }}">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Terinfo 2024</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <!-- Preview Gambar -->
    <script>
        function tampilPreview(gambar, idPreview) {
            let gb = gambar.files;
            for (let i = 0; i < gb.length; i++) {
                ...
                if (gbPreview.type.match(imageType)) {
                    ...
                    alert("Tipe file bukan file image.")
                }
            }
        }
    </script>
